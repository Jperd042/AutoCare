...
export default function BookingsList() {
  ...
  return (
    <div className={tab === 'new' ? 'flex flex-col h-full' : 'space-y-5'}>

      {/* ── Tab header ──────────────────────────── */}
      <div className={`flex gap-1 p-1 bg-surface-card border border-surface-border rounded-xl w-fit max-w-full overflow-x-auto shrink-0 ${tab === 'new' ? 'mb-5' : ''}`}>
        {[
